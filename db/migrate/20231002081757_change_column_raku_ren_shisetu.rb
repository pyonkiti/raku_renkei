class ChangeColumnRakuRenShisetu < ActiveRecord::Migration[5.2]
    ...
    def set_null(flg)
        change_column_null  :raku_ren_shisetus,     :seikyu_keylink,    flg     # 請求キーリンク
        change_column_null  :raku_ren_shisetus,     :bango,             flg     # 番号
        change_column_null  :raku_ren_shisetus,     :shisetu,           flg     # 施設名
        change_column_null  :raku_ren_shisetus,     :shisetu_cd,        flg     # 施設コード
        change_column_null  :raku_ren_shisetus,     :userkey,           flg     # ユーザーキー
    end
